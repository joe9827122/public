...
namespace DataTableTest.Controllers
{
    public class OperasController : Controller
    {
        ...
        {
              return _context.Opera != null ? 
                          View(await _context.Opera.ToListAsync()) :
        ...
        {
            if (id == null || _context.Opera == null)
            {
                return NotFound();
            }

            var opera = await _context.Opera
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var opera = await _context.Opera.FindAsync(id);
            if (opera == null)
            {
                return NotFound();
            }
        ...
        {
          return (_context.Opera?.Any(e => e.OperaID == id)).GetValueOrDefault();
        }
    }
}
